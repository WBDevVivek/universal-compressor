...
/**
 * Isolated PDF Layout - Wraps all underlying PDF compilation sub-routes
...
export default function PdfLayout({ children }: PdfLayoutProps) {
  return (
    <div className="w-full min-h-screen bg-slate-950">
      ...
      <nav className="w-full max-w-6xl mx-auto px-4 pt-6 flex items-center justify-between" aria-label="PDF Sub-route Breadcrumb">
        <Link
          href="/"
